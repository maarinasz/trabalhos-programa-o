...
botao_potencia = tk.Button(janela, text="^", command=potencia, width=13, height=4, font=("Arial", 12))
botao_potencia.grid(column=1, row=6)

botao_raiz = tk.Button(janela, text="√", command=raiz, width=13, height=4, font=("Arial", 12))
botao_raiz.grid(column=2, row=6)

botao_inverso = tk.Button(janela, text="1/x", command=inverso, width=13, height=4, font=("Arial", 12))
botao_inverso.grid(column=3, row=6)
